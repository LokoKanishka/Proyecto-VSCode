...
def main() -> int:
    ...
    parser.add_argument("--model", default=os.getenv("LUCY_VLLM_MODEL", "gpt-oss:20b"))
    parser.add_argument("--host", default="0.0.0.0")
    parser.add_argument("--port", type=int, default=8000)
    parser.add_argument("--max-context", type=int, default=int(os.getenv("LUCY_VLLM_MAX_CONTEXT", "16384")))
